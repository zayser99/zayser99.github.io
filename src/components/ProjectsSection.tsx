            ...
            <MotionWrapper key={project.title} delay={index * 0.2}>
              <GlassCard className="group overflow-hidden dark:border-blue-500/10 h-full flex flex-col">
                <CardHeader className="bg-gradient-to-r from-blue-500/5 to-indigo-500/5">
                  ...
                  <CardSubTitle className="text-center md:text-left transition-colors duration-300">
                    {project.subTitle}
                  </CardSubTitle>
                </CardHeader>
                ...
                <CardFooter className="flex justify-center md:justify-start items-center border-t border-border/30 bg-gradient-to-r from-blue-500/5 to-indigo-500/5">
